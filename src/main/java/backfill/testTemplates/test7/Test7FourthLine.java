...
public class Test7FourthLine {

    public int fifthLine(Workbook workbook,
                         Sheet sheet,
                         int lastRowNumer,
        ...
        for (int i = 0; i <= 4; i++) {
            switch (i) {
                case 1:
                    ...
                    cell2.setCellValue(defaultValue.testNamesForSixthTest().get(3));
                    break;
                case 2:
                ...
                case 3:
                    ...
                    cell4.setCellValue(defaultValue.expResultsForSixthTest().get(3));
                    break;
            }
        }
