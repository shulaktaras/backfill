...
public class Test7SecondLine {

    public int secondLine(Workbook workbook, Sheet sheet, int lastRowNumer, DefaultValue defaultValue, File file) throws IOException {
        lastRowNumer += 1;
        ...
        for (int i = 0; i <= 4; i++) {
            switch (i) {
                case 1:
                    ...
                    cell2.setCellValue(defaultValue.testNamesForSixthTest().get(1));
                    break;
                case 2:
                ...
                case 3:
                    ...
                    cell4.setCellValue(defaultValue.expResultsForSixthTest().get(1));
                    break;
            }
        }
