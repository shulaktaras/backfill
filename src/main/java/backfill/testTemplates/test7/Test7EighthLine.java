...
public class Test7EighthLine {

    public int eighthLine(Workbook workbook,
                         Sheet sheet,
                         int lastRowNumer,
        ...
        for (int i = 0; i <= 4; i++) {
            switch (i) {
                case 1:
                    ...
                    cell2.setCellValue(defaultValue.testNamesForSixthTest().get(7));
                    break;
                case 2:
                ...
                case 3:
                    ...
                    cell4.setCellValue(defaultValue.expResultsForSixthTest().get(7));
                    break;
            }
        }
